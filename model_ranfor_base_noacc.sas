...
%macro model_ranfor_base_noacc(_infile_data_,list_var_file,path_for_binary_mdl_impl,model_identifier,_target_type_,
...
20) whichlib: name of the SAS library where to store the output data sets generated by "model_ranfor_base_noacc" (by default=same inidcating that the same library as the model data should be used).
*/

%put Executing: model_ranfor_base_noacc;
...
%exit: %mend model_ranfor_base_noacc;
