%include '/sasdata/projects/DA/machine_learning/SAS_MACROS/oct31_7BPG/macrocatalog_definitions.sas';
%macro model_ranfor_iteration_noacc(_repetition_,_infile_data_,list_var_file,path_for_binary_mdl_impl,model_identifier,_target_type_,
...
11) _trainfr_: fraction of the original data set which is chosen for train. If trainvalidation=bootstrap, the 
	train data set has the same number of records as the original dataset however some records are repeated more than one time (sampling with replacement)
...
%put Executing: model_ranfor_iteration_noacc &list_var_file;
...
%put RUNNING MODEL NO. &i;
	...
	/* create model */
%model_ranfor_base_noacc(&_infile_data_,&list_var_file,&path_for_binary_mdl_impl,&model_identifier.&i,&_target_type_,
...
%exit: %mend model_ranfor_iteration_noacc;
%include '/sasdata/projects/DA/machine_learning/SAS_MACROS/oct31_7BPG/finalcode_to_execute.sas';
